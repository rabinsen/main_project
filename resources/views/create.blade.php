        ...
        <form enctype="multipart/form-data" action="{{ route('store') }}" method="POST">
            <div class="form-group">
                ...
                @if ($errors->has('title'))
                    ...
                    <strong class = "errorCol">{{ $errors->first('title') }}</strong>
                  </span>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('price'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('price') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('type'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('type') }}</strong>
                  </span>
                @endif
            ...
            <div class="form-group">
                ...
                @if ($errors->has('status'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('status') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('readyToMove'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('readyToMove') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('address'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('address') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('city'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('city') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('country'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('country') }}</strong>
                  </span>
                @endif
            ...
            <div class="form-group">
                ...
                @if ($errors->has('map'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('map') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('lat'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('lat') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('lng'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('lng') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('landArea'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('landArea') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('houseArea'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('houseArea') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('plotted'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('plotted') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('storey'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('storey') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('bedroom'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('bedroom') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('bathroom'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('bathroom') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('kitchen'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('kitchen') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('roadDistance'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('roadDistance') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('description'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('description') }}</strong>
                  </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('thumbnail'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('thumbnail') }}</strong>
                  </span>
                @endif
            ...
            <div class="form-group">
                ...
                @if ($errors->has('slide1'))
                    <span class="help-block">
                    <strong class = "errorCol">{{ $errors->first('slide1') }}</strong>
                  </span>
                @endif
